...
class Game {
	...
	public boolean takeUserInput() {
		if ( noOfGuesses < 10) {
			...
			System.out.println("Number of attempts for guessing finished....Better luck next time\n");
			return true;
		}
	}
	
	
	//method to check user status of guess
	public boolean isCorrectGuess() {
		
		if ( systemInput == userInput ) {
			System.out.println("Congratulations , you have guess the number " + systemInput +
...
public class GuessTheNumber {
	...
	public static void main(String[] args) {
		...
		System.out.println("Pick one choice : ");
